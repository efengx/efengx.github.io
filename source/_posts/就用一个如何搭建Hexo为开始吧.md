...
tags:
---
精力了很多，之前开过很多的blog，基本上都是自己购买服务器搭建的，大部分是基于php的产品。
...
打开命令行界面window cmd/mac os terminal/linux (这个不用呢只要不是图形界面进入就是了，我很少在linux下用图形界面>.<)。
...
% hexo generate
```
[点我查看更多的命令和其他相关文档](https://hexo.io/zh-cn/docs/commands)
